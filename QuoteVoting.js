...
//A class to hold all the voting functionality
module.exports = class QuoteVoting
{
    //Wrappers for the functionality, returns the promises
    static async sendQuoteVote(interaction) {return sendQuoteVote(interaction)};
    static async castVote(interaction, funnyRank, cursedRank, quoteKey) { return castVote(interaction, funnyRank, cursedRank, quoteKey)};
    static async showUserLeaderboards(interaction, statToShow) { return showUserLeaderboards(interaction, statToShow)};
    static async showLeaderboardMenu(interaction, selection) { return showLeaderboardMenu(interaction, selection)};
    static async displayTopQuoteLeaderboard(interaction, leaderboardToUse, numberToShow) { return displayTopQuoteLeaderboard(interaction, leaderboardToUse, numberToShow)};
    static async showUserStats(interaction) { return showUserStats(interaction)};
    static async closeMenu(interaction) { return closeMenu(interaction); }
}
